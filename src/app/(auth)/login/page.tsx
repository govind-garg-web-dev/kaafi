          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-xs text-[#64748b]" style={{ fontFamily: "var(--font-inter)" }}>Password</label>
                <button type="button" className="text-xs text-violet-400 hover:text-violet-300 transition-colors" style={{ fontFamily: "var(--font-inter)" }}>
                  Forgot password?
                </button>
              </div>
